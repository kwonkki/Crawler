...
public class FormParams_7C {
	...
	public FormParams_7C setTravelOption(TravelOption travelOption) {
	...
	public FormParams_7C setOrgStation(OrgStation orgStation) {
	...
	public FormParams_7C setDestStation(DestStation destStation) {
	...
	public FormParams_7C setDepartureTime(String departureTime) {
	...
	public FormParams_7C setReturnTime(String returnTime) {
	...
	public FormParams_7C setAdultNum(int adultNum) {
	...
	public FormParams_7C setChildNum(int childNum) {
	...
	public FormParams_7C setFormParams(List<NameValuePair> formParams) {
