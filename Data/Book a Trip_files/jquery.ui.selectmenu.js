    ...
    $.widget("ui.selectmenu", {
        ...
        _create: function () {
			...
			.bind('mousedown.selectmenu', function (event) {
                ...
                //make sure that selected dropdown menu is focus upon mousedown
			    $(this).focus();
			...
			//remove focus on first meal dropdown
            //PBI 1265
            ...
            //alignment fix for childbirthdate dialog
            if ($('#childBirthDateDialog').find($('#' + this.element.attr('id'))).length > 0) {
                $('#childBirthDateDialog').find($('#' + this.element.attr('id'))).width(1);
            }
            //end alignment fix for childbirthdate dialog

            document.getElementById(this.element.attr('id')).style.height = '1px';
            document.getElementById(this.element.attr('id')).style.visibility = 'hidden';

            //alignment fix for flights change page
            if ($('#marketDate_1 #marketDateChangeFlight').find($('#' + this.element.attr('id'))).length > 0) {
                document.getElementById(this.element.attr('id')).style.height = '1px';
                document.getElementById(this.element.attr('id')).style.visibility = 'hidden';
                document.getElementById(this.element.attr('id')).style.width = '1px';
            }
            if ($('#marketDate_2 #marketDateChangeFlight').find($('#' + this.element.attr('id'))).length > 0) {
                document.getElementById(this.element.attr('id')).style.height = '1px';
                document.getElementById(this.element.attr('id')).style.visibility = 'hidden';
                document.getElementById(this.element.attr('id')).style.width = '1px';
            }
            //end alignment fix for flights change page
